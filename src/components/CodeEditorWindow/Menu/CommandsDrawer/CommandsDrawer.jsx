...
const CommandsDrawer = ({ open, toggleDrawer, handleInsertCommand }) => {
  ...
  useEffect(() => {
    fetch(import.meta.env.BASE_URL + './openapi.json')
      ...
      .catch((e) => {
        enqueueSnackbar('Komutlar alınırken hata', errorSnackbarOptions);
        console.error(e);
      });
  }, []);
    ...
    >
      <div>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, mr: 2 }}>
          <Typography variant={'h5'}>Komutlar</Typography>
          <Box sx={{ flexGrow: 1 }} />
        ...
        <Typography variant={'body1'} mb={4}>
          Düzenleyicide kullanılabilecek komutların listesi.
        </Typography>
